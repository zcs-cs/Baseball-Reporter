...
public class ExamplesModule extends ReportModule<BaseballData>
{
    ...
    private String teamStatisticsExample()
    {
        ...
        statement += "This puts their standing at " + data.teamStandingsPosition(true) + 
                    ".\nThey have had " + data.teamStandingsWins(true) + " wins.\nThey have had a " + data.teamStandingsStreak(true)+" game win streak.\nThey have had " + data.teamStandingsStreak(true) + " losses.";
        return statement;
    }
    ...
    private String TeamPlayersStatisticsExample()
    {
        ...
        int runDescriptionIndex = (data.teamPlayersRuns(true)[0] > 5) ? 5 : Function.line(0, 0, runDescriptions.length, 5, data.teamPlayersRuns(true)[0]);
